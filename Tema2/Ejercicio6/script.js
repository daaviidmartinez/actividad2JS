...
function simulateBattle(firstRace,firstCharacterStats,secondRace,secondCharacterStats) {
    ...
    if (firstCharacterStats[1] <= secondCharacterStats[1]) {
        while (vida1 >= 1 && vida2 >= 1) {
            ...
            console.log("Vida del " +firstRace+ " es: " +vida1+" y su defensa es: "+defense);
            console.log("Vida del " +secondRace+ " es: "+vida2+" y su daño en ataque es: "+damage);
            if (defense < damage) {
                vida1 -= damageOG;
            ...
            console.log("Vida del " +firstRace+ " es " +vida1);
            if (vida1 >= 1) {
            damage = getDamage(firstRace,firstCharacterStats)
            defense = getDefense(secondRace,secondCharacterStats);
            damageOG = damage - defense;
            console.log("Vida del " +secondRace+ " es: "+vida2+" y su defensa es:"+defense);
            console.log("Vida del " +firstRace+ " es: " +vida1+" y su daño en ataque es:"+damage);
            if (defense < damage) {
                vida2 -= damageOG;
                console.log("Daño directo: "+damageOG);
            } else { 
            ...
            console.log("Vida del " +secondRace+ " es " +vida2);
            }
        }
        if (vida1 >= 1) {
            console.log("Enhorabuena ha ganado el "+firstRace);
        } else console.log("Enhorabuena ha ganado el "+secondRace);
